  ...
  if (!isAdminOrVendor) {
    return (
      <div className="bg-white border border-gray-200 rounded-xl p-8 text-center">
        ...
        <p className="text-gray-600">Only admin or vendor can manage stock inventory.</p>
      </div>
    );
  }
        ...
        <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_auto_auto] lg:items-center">
          <label className="relative block">
            ...
            <input
              ...
              placeholder="Search product, SKU, brand, vendor"
              className="w-full rounded-2xl border border-gray-200 bg-gray-50 py-3 pl-11 pr-4 text-sm focus:border-black focus:bg-white focus:outline-none"
            />
          </label>
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="mt-1 text-xs text-gray-500">
                        {(product?.category?.name || product?.productType || "General") +
                          (role === "admin" && product?.vendor?.storeName
                            ? ` • ${product.vendor.storeName}`
                            : "")}
                      </p>
                    </div>
