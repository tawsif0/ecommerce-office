              ...
              return (
                ...
                >
                    ...
                    <div className="min-w-0">
                      <div className="flex flex-wrap items-center gap-2">
                        <span
                          className={`inline-flex h-10 w-10 items-center justify-center rounded-2xl ${
                            notification.isRead ? iconClass : "bg-white/10 text-white"
                          }`}
                        >
                        ...
                        <span
                          className={`inline-flex rounded-full px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] ${
                            notification.isRead ? badgeClass : "bg-white/10 text-white"
                          }`}
                        >
                          {typeLabel}
                        </span>
                      ...
                      <p
                        className={`mt-2 text-sm leading-6 ${
                          notification.isRead ? "text-slate-600" : "text-slate-200"
                        }`}
                      >
                  ...
                  >
                    ...
                    <span>
                      {notification.isRead ? "Already read" : "Marks as read when opened"}
                    </span>
                  </div>
                </MotionButton>
              );
